...
const PlayGame = () => {
  ...
  const { playerTurn, roundNo, isContinuePending, onRoundStart } =
    useGameState();
          ...
          <div className="flex justify-between max-w-xl items-center m-auto">
            <div className="font-bold text-blue-500 text-3xl">
              ...
              <div className="flex flex-col ">
                <p className="text-white text-xs font-primary">
                  Wins: {player1Wins}
                </p>
                <p className="text-white text-xs font-primary">
                  Losses: {player1Losses}
                </p>
                <p className="text-white text-xs font-primary">Draws: {draw}</p>
              </div>
            </div>
